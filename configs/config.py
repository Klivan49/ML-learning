...
EDUCATION = {
    "target_columns": [
        "лекции", "лабораторные", "пз", "курсовые", "методички",
        "математика", "физика", "программирование", "информатика", "химия",
    ],
    "extension_to_category": {
        "лекции":        ["pdf", "doc", "docx", "ppt", "pptx", "odp", "txt", "md"],
        "лабораторные":  ["pdf", "doc", "docx", "xls", "xlsx", "py", "cpp", "c", "js", "ipynb", "md"],
        "пз":            ["pdf", "doc", "docx", "xls", "xlsx", "txt", "md"],
        "курсовые":      ["pdf", "doc", "docx", "ppt", "pptx", "zip", "rar"],
        "методички":     ["pdf", "doc", "docx", "txt", "md"],
        "математика":    ["pdf", "doc", "docx", "xls", "xlsx", "tex", "md"],
        "физика":        ["pdf", "doc", "docx", "xls", "xlsx", "tex", "md"],
        "программирование": ["py", "js", "ts", "java", "c", "cpp", "cs", "go", "rs", "rb", "php", "swift", "kt", "ipynb", "md"],
        "информатика":   ["pdf", "doc", "docx", "py", "js", "cpp", "md", "xls", "xlsx", "accdb", "sql"],
        "химия":         ["pdf", "doc", "docx", "xls", "xlsx", "txt", "md"],
    },
    "category_keywords": {
        "лекции":        ["лекц", "lection", "lecture", "лекция", "тема", "topic_", "theme_", "семинар"],
        "лабораторные":  ["лаб", "laboratory", "lab_", "лабораторная", "labwork"],
        "пз":            ["пз", "практик", "практическая", "сем", "семинар", "hw", "homework", "дз", "домашк", "задани"],
        "курсовые":      ["курс", "coursework", "course_", "диплом", "diploma"],
        "методички":     ["метод", "method", "guide", "manual", "инструкц"],
        "математика":    ["математик", "math", "algebra", "алгебр", "геометри", "geometry", "matan", "матан", "дискрет"],
        "физика":        ["physics", "physic", "физик", "механик", "термодинам", "optics", "оптика", "электр"],
        "программирование": ["programming", "program", "программир", "algorithm", "алгоритм", "coding", "data structure", "структур данных", "веб", "web", "database", "база данных"],
        "информатика":   ["informatics", "информатик", "it", "computer", "comp_", "инфо", "os", "aoc", "архитектур"],
        "химия":         ["chem", "хими", "organic", "органическ", "неорган", "биохим"],
    },
    "synthetic_filename_patterns": {
        "лекции":        ["лекция_{n}_{topic}", "lection_{n}_{topic}", "лекц_{date}_{topic}", "lecture_{date}_{topic}", "тема_{n}_{topic}"],
        "лабораторные":  ["лаб_{n}_{topic}", "lab_{n}_{topic}", "лабораторная_{n}_{topic}", "labwork_{date}_{topic}"],
        "пз":            ["пз_{n}_{topic}", "hw_{n}_{topic}", "дз_{date}_{topic}", "практическая_{n}_{topic}", "семинар_{n}_{topic}"],
        "курсовые":      ["курсовая_{topic}", "coursework_{topic}", "диплом_{topic}", "course_project_{topic}"],
        "методички":     ["методичка_{topic}", "method_guide_{topic}", "manual_{topic}", "инструкция_{topic}"],
        "математика":    ["matan_{n}", "algebra_{n}", "geometry_{n}", "math_{date}_{topic}", "алгебра_{n}", "геометрия_{n}"],
        "физика":        ["physics_{n}", "phys_{date}", "mechanics_{n}", "физика_{n}", "термодинамика_{n}"],
        "программирование": ["prog_{n}", "task_{n}", "project_{topic}", "algorithm_{n}", "web_app_{n}", "database_{n}"],
        "информатика":   ["informatics_{n}", "os_{n}", "aoc_{n}", "computer_science_{n}", "inf_{n}"],
        "химия":         ["chemistry_{n}", "chem_{date}", "organic_{n}", "inorganic_{n}", "хімія_{n}"],
    },
    "size_ranges": {
        "лекции": (50_000, 20_000_000), "лабораторные": (5_000, 5_000_000), "пз": (5_000, 2_000_000),
        "курсовые": (100_000, 50_000_000), "методички": (50_000, 10_000_000),
        "математика": (10_000, 10_000_000), "физика": (10_000, 10_000_000),
        "программирование": (500, 1_000_000), "информатика": (5_000, 10_000_000), "химия": (10_000, 10_000_000),
    },
    "synthetic_corpora": {
        "lecture": ["лекция", "тема", "определение", "теорема", "формула", "пример", "доказательство", "свойство", "функция", "уравнение", "матрица", "дифференциал", "интеграл"],
        "code": ["def", "import", "class", "return", "if", "else", "for", "while", "int", "float", "string", "print", "input", "function"],
        "general": ["задание", "решение", "ответ", "вариант", "номер", "задача", "пример", "выполнил", "проверил", "оценка"],
    },
}
